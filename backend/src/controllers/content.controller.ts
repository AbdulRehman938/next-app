...
export async function getAboutValuesHandler(_req: Request, res: Response, next: NextFunction) {
  try {
...
export async function getBlogPostsHandler(_req: Request, res: Response, next: NextFunction) {
  try {
...
export async function getLiveMetricsHandler(_req: Request, res: Response, next: NextFunction) {
  try {
